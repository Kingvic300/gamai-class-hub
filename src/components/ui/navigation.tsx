          ...
          <div className="flex justify-between">
            ...
            >
              ...
              <button 
                ...
                className="flex items-center space-x-2 px-3 py-2 text-sm font-medium text-muted-foreground hover:text-foreground hover:bg-muted rounded-lg w-full text-left"
              >
                <span>Logout</span>
              </button>
            </Button>
